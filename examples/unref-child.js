...
This example demonstrates how unref-ing a pending operation, in this case a child process
...
// We need to ignore stdio otherwise the open sockets keep parent alive
var sleep = cp.spawn('sleep', [ '10' ], { stdio: [ 'ignore', 'ignore', 'ignore' ] })
